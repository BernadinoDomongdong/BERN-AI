 ...
 * GLOBAL_RATE_LIMIT_KEY usage in api/chat.js. That's a coarse, single-
 * instance-scoped cap on total requests across every visitor, which is
 * a meaningfully better defense than per-IP limits alone against a
 * *distributed* flood (many source IPs, low volume each) aimed at
 * exhausting this app's shared OpenRouter free-tier quota — the kind of
 * attack per-IP limiting is specifically blind to.
 *
